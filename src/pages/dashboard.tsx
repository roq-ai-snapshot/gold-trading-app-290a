...
import { useOwnerCount, useGoldTradeCount, useMarketAnalysisCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const marketAnalysisStat = useMarketAnalysisCount();
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    },
    {
      ...
      result: marketAnalysisStat?.data,
      isLoading: marketAnalysisStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },

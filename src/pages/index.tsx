  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Gold Trading Application - Your gateway to seamless, secure, and sophisticated gold trading experiences, unlocking new opportunities every day."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Gold Trading Application - Your gateway to seamless, secure, and sophisticated gold trading experiences, unlocking new opportunities every day.`}
            </Text>
            <Box
